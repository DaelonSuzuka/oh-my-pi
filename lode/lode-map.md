...
| [local-build/harness-notice.md](local-build/harness-notice.md) | Why harness-generated messages arrive marked, and why `attribution` rather than the wire-level system promotion is the discriminator |
